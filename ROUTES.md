...
- CKD Meal Planner: `https://rowanworkshop.com/ckd/`
- TenderFit HU: `https://rowanworkshop.com/tenderfit/`
- Web App Repair: `https://rowanworkshop.com/repair/`
...
- The root and project paths are hosted together on GitHub Pages. HTTP verification returns `200`; GitHub is still issuing the custom-domain TLS certificate before HTTPS can be enforced.
